...
define :unicorn_config, :listen => nil, :working_directory => nil, :worker_processes => 2, :pid => nil, :stderr_path => nil, :stdout_path => nil, :notifies => nil, :owner => nil, :group => nil, :mode => nil do
